...
function getComputerChoice(playerChoice) {
    ...
    if (difficulty === "Medium") {
        ...
        return Math.random() < 0.2 ? counterMoves[playerChoice][Math.floor(Math.random() * 2)] : choices[Math.floor(Math.random() * choices.length)];
    }
    ...
    if (difficulty === "Hard") {
        ...
        return Math.random() < 0.3 ? counterMoves[mostUsedMove][Math.floor(Math.random() * 2)] : choices[Math.floor(Math.random() * choices.length)];
    }
}
